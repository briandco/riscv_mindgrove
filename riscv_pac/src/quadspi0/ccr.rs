...
#[doc = "Field `DUMMY_BIT` reader - Set value 1 to send Dummy Cycles. Default 0"]
pub type DummyBitR = crate::BitReader;
#[doc = "Field `DUMMY_BIT` writer - Set value 1 to send Dummy Cycles. Default 0"]
pub type DummyBitW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MM_MODE` reader - Memory Mapped Mode. Default value 0. For XIP Mode, set 0, for RAM Mode, set 1."]
pub type MmModeR = crate::BitReader;
#[doc = "Field `MM_MODE` writer - Memory Mapped Mode. Default value 0. For XIP Mode, set 0, for RAM Mode, set 1."]
pub type MmModeW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 29 - Set value 1 to send Dummy Cycles. Default 0"]
    #[inline(always)]
    pub fn dummy_bit(&self) -> DummyBitR {
        DummyBitR::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - Memory Mapped Mode. Default value 0. For XIP Mode, set 0, for RAM Mode, set 1."]
    #[inline(always)]
    pub fn mm_mode(&self) -> MmModeR {
        MmModeR::new(((self.bits >> 30) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:7 - Instruction"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dummy_bit(&mut self) -> DummyBitW<CcrSpec> {
        DummyBitW::new(self, 29)
    }
    #[doc = "Bit 30 - Memory Mapped Mode. Default value 0. For XIP Mode, set 0, for RAM Mode, set 1."]
    #[inline(always)]
    #[must_use]
    pub fn mm_mode(&mut self) -> MmModeW<CcrSpec> {
        MmModeW::new(self, 30)
    }
}
