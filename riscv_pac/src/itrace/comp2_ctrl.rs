...
pub type R = crate::R<Comp2CtrlSpec>;
#[doc = "Register `COMP2_CTRL` writer"]
pub type W = crate::W<Comp2CtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pinput_mode(&mut self) -> PinputModeW<Comp2CtrlSpec> {
        PinputModeW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Secondary comparator input mode. 0: iaddr, 1: context, 2: tval, 3: daddr."]
    #[inline(always)]
    #[must_use]
    pub fn sinput_mode(&mut self) -> SinputModeW<Comp2CtrlSpec> {
        SinputModeW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Mentions the comparison to be done for primary input. 0-equality, 1-not equal, 2-less than, 3-less than equal to, 4-greater than, 5-greater than equal to, 6-False, 7-True"]
    #[inline(always)]
    #[must_use]
    pub fn pinput_comp_mode(&mut self) -> PinputCompModeW<Comp2CtrlSpec> {
        PinputCompModeW::new(self, 4)
    }
    #[doc = "Bits 8:10 - Mentions the comparison to be done for secondary input. 0-equality, 1-not equal, 2-less than, 3-less than equal to, 4-greater than, 5-greater than equal to, 6-False, 7-True"]
    #[inline(always)]
    #[must_use]
    pub fn sinput_comp_mode(&mut self) -> SinputCompModeW<Comp2CtrlSpec> {
        SinputCompModeW::new(self, 8)
    }
    #[doc = "Bits 12:13 - The comparison to be performed between primary and secondary input."]
    #[inline(always)]
    #[must_use]
    pub fn ps_comp_mode(&mut self) -> PsCompModeW<Comp2CtrlSpec> {
        PsCompModeW::new(self, 12)
    }
    #[doc = "Bit 14 - Sends a support packet when primary comparator matches"]
    #[inline(always)]
    #[must_use]
    pub fn pnotify(&mut self) -> PnotifyW<Comp2CtrlSpec> {
        PnotifyW::new(self, 14)
    }
    #[doc = "Bit 15 - Sends a support packet when secondary comparator matches"]
    #[inline(always)]
    #[must_use]
    pub fn snotify(&mut self) -> SnotifyW<Comp2CtrlSpec> {
        SnotifyW::new(self, 15)
    }
}
#[doc = "Control register for 1st comparator\n\nYou can [`read`](crate::Reg::read) this register and get [`comp2_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comp2_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp2CtrlSpec;
impl crate::RegisterSpec for Comp2CtrlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`comp2_ctrl::R`](R) reader structure"]
impl crate::Readable for Comp2CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`comp2_ctrl::W`](W) writer structure"]
impl crate::Writable for Comp2CtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets COMP2_CTRL to value 0"]
impl crate::Resettable for Comp2CtrlSpec {
